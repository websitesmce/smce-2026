...
import departmentImage from "../../assets/department-img/cse-main.jpeg";
...
export default function DepartmentCSE() {
  ...
  // Animate tab expansion on mobile/tablet
  useEffect(() => {
  ...
  return (
    <section className="pt-[120px] px-6 sm:px-10 md:px-16 lg:px-24 pb-24 bg-white text-gray-800">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-6 text-base leading-relaxed">
                <p className="text-xl">
                  ...
                  branch in{" "}
                  <span className="font-semibold text-[#800000]">2006</span>{" "}
                  with an initial intake of{" "}
                  <span className="font-semibold text-[#800000]">60</span> and
                  to <span className="font-semibold text-[#800000]">420</span>{" "}
                  in the following years. A{" "}
                  <span className="font-semibold text-[#800000]">
                    post graduate course
                  </span>{" "}
                  also has been introduced in the year{" "}
                  <span className="font-semibold text-[#800000]">2010</span> in{" "}
                  <span className="font-semibold text-[#800000]">
                    Computer Science Engineering (M.Tech. CSE)
                  </span>
                  .{" "}
              ...
              <div>
                ...
                <ul className="space-y-4 text-base text-left max-w-xl mx-auto leading-relaxed">
                  <li>
                    ...
                    To educate students to be effective problem solvers and life
                    long learners in technical, innovative and entrepreneurial
                    skills.
                  </li>
                  <li>
              ...
              <div className="pl-0 sm:pl-10 pt-10 sm:pt-0 space-y-5">
                ...
                <ul className="space-y-3 text-base">
                  <li>
                    ...
                    Java Full Stack Development, Cloud Programming, etc.
                  </li>
                  <li>
                    <span className="font-semibold text-[#800000]">
                      Hardware skills:
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-base leading-relaxed">
                ...
                <li>
                  ...
                  Understand the progressive changes in computing and possess
                  data of context-aware relevance of paradigms.
                </li>
              </ul>
            </div>
          </div>
        ...
        {activeTab === 3 && (
          <div className="space-y-16 text-gray-800">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Explore our state-of-the-art computer labs built to support AI &
                DS learning with high-end systems and software.
              </p>
            </div>
            ...
            <div className="bg-white border-l-4 border-[#800000] shadow-md p-6 sm:p-10 rounded-xl max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-base leading-relaxed">
                We have several computer labs equipped with the latest software
                and workstations. It is connected to the internet through a
                lease line to facilitate high-speed internet access.
              </p>
              <p className="text-base leading-relaxed">
