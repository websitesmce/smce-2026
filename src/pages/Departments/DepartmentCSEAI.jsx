        ...
        {activeTab === 2 && (
          <div className="space-y-16 text-gray-800">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Download the Course Structure and Syllabus of four years of AI
                course
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto space-y-6">
              <div className="bg-white border-l-4 border-[#800000] p-5 sm:p-6 rounded-xl shadow-md flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <a
                    href="https://drive.google.com/file/d/12rjwrD4oIh-98PW9CW522GkEjb_TnLei/view"
                    target="_blank"
