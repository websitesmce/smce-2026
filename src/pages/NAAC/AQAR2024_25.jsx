    ...
    sections: [
      {
        ...
        points: [
          { id: "6.1.1", text: "The governance of the institution is reflective of and in tune with the vision and mission of the institution.", pdf: "" },
          { id: "6.1.2", text: "The effective leadership is visible in various institutional practices such as decentralization and participative management.", pdf: "" }
        ]
      },
      {
        title: "6.2 Strategy, Development, and Deployment",
        points: [
          { id: "6.2.1", text: "The institution's strategic/perceptive plan is effectively deployed.", pdf: "" },
          { id: "6.2.2", text: "The functioning of the institutional bodies is effective and efficient as visible from policies, administrative setup, appointment and service rules, procedures, etc.", pdf: "" },
          { id: "6.2.3", text: "Implementation of e-governance in areas of operations, administration, finance, and accounts, student's admission and support examination.", pdf: "" }
        ]
      },
      {
        title: "6.3 Faculty Empowerment Strategies",
        points: [
          { id: "6.3.1", text: "The institution has effective welfare measures for teaching and non-teaching staff.", pdf: "" },
          { id: "6.3.2", text: "Number of teachers provided with financial support to attend conferences/workshop and towards membership fee of professional bodies during the year.", pdf: "" },
          { id: "6.3.3", text: "Number of professional development/administrative training programs organized by the institution for teaching and non-teaching staff during the year.", pdf: "" },
          { id: "6.3.4", text: "Number of teachers undergoing online/face-to-face faculty development programs (FDP) during the year.", pdf: "" },
          { id: "6.3.5", text: "Institution's performance appraisal system for teaching and non-teaching staff.", pdf: "" }
        ]
      },
      {
        title: "6.4 Financial Management and Resource Mobilization",
        points: [
          { id: "6.4.1", text: "Institution conducts internal and external financial audits regularly.", pdf: "" },
          { id: "6.4.2", text: "Funds/grants received from the non-government bodies and individual philanthropers during the year.", pdf: "" },
          { id: "6.4.3", text: "Institutional strategies for mobilization of funds and the optimal utilization of resources.", pdf: "" }
        ]
      },
      {
    ...
    sections: [
      {
        ...
        points: [
          { id: "7.1.1", text: "Measures initiated by the institution for the promotion of gender equity during the year", pdf: "" },
          { id: "7.1.2", text: "The institution has facilities for alternate sources of energy and energy conversion measures", pdf: "" },
          { id: "7.1.3", text: "Describe the facilities in the institution for the management of the following types of degradable and non-degradable waste", pdf: "" },
          { id: "7.1.4", text: "Water conversion facilities available in the institution", pdf: "" },
          { id: "7.1.5", text: "Green campus initiatives included", pdf: "" },
          { id: "7.1.6", text: "Include quality audits or environment and energy are regularly undertaken by the institution", pdf: "" },
          { id: "7.1.7", text: "The institution has a divyanjan friendly barrier-free environment", pdf: "" },
          { id: "7.1.8", text: "Describe the institutional efforts/initiatives in providing an inclusive environment that is tolerance and harmony towards cultural, regional, linguistic, communal, socio-economic, and other diversities", pdf: "" },
          { id: "7.1.9", text: "Sensitization of students and employees of the institution to the constitutional obligations, values, rights, duties, and responsibilities of citizens", pdf: "" },
          { id: "7.1.10", text: "The institution has prescribed codes of conduct for students, teachers, administrators, and conducts periodic programs in this regard", pdf: "" },
          { id: "7.1.11", text: "The institution celebrates or organizes national and international commemorative days, events, and festivals", pdf: "" }
        ]
      },
      {
        title: "7.2 Best Practices",
        points: [
          { id: "7.2.1", text: "Describe two best practices successfully implemented by the institution as per NAAC provided in the manual", pdf: "" }
        ]
      },
      {
        title: "7.3 Institutional Distinctiveness",
        points: [
          { id: "7.3.1", text: "Portray the performance of the institution in one area distinctive to its priority", pdf: "" }
        ]
      }
    ]
  }
